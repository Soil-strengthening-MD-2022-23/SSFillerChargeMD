...
const int CLUSTERSTART = 71;//start calculating after reading 50 times,100,000*20=2,000,000
...
main()
{
  ...
  datafiller = fopen("..//filler_equi.lammpstrj","r");
  datachain = fopen("..//chains_equi.lammpstrj","r");
